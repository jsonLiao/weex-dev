<template>
    <div class="wrapper">
        <scroller class="scroller" @click="chooseChannel" scroll-direction="horizontal" loadmoreoffset="750px" show-scrollbar=false>
            ...
            <text class="i-c c-act">精选</text>
            <text class="i-c">服装饰品</text>
            <text class="i-c">基础护肤</text>
            <text class="i-c">个人护理</text>
            <text class="i-c">彩妆香水</text>
            <text class="i-c">母婴儿童</text>
            <text class="i-c">食品饮料</text>
            <text class="i-c">鞋靴箱包</text>
            <text class="i-c">家居厨卫</text>
            <text class="i-c">数码家电</text>
        </scroller>
